        ...
        <div class="col-xl-6">
            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <div class="progress push">
                        <div class="progress-bar bg-danger" role="progressbar" style="width: 50%; height: 8px;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress push">
                        <div class="progress-bar bg-warning" role="progressbar" style="width: 70%; height: 8px;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress push">
                        <div class="progress-bar bg-info" role="progressbar" style="width: 90%; height: 8px;" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress push">
                        <div class="progress-bar bg-success" role="progressbar" style="width: 100%; height: 8px;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress push">
                        <div class="progress-bar bg-flat" role="progressbar" style="width: 100%; height: 8px;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="progress push">
                        <div class="progress-bar bg-pulse" role="progressbar" style="width: 100%; height: 8px;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
            <!-- END Progress Mini -->
