...
<div class="bg-gd-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('<?php echo $cb->assets_folder; ?>/img/various/bg-fe-pattern.png');">
        <div class="content content-top text-center">
            <div class="py-50">
                <h1 class="font-w700 text-white mb-10">Project X</h1>
                <h2 class="h4 font-w400 text-white-op">Web Design and Development.</h2>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white border-b">
    <div class="content content-full clearfix">
        ...
        <a class="btn btn-secondary" href="fe_portfolio_2cols.php">
        ...
        <div class="row py-20">
            <div class="col-sm-6 invisible" data-toggle="appear">
                ...
                <div class="js-slider slick-nav-black slick-dotted-inner slick-dotted-white" data-dots="true" data-arrows="true">
                    <div>
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo1.png" alt="Project Promo 1">
                    </div>
                    <div>
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo2.png" alt="Project Promo 2">
                    </div>
                    <div>
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo3.png" alt="Project Promo 3">
                    </div>
                </div>
                <!-- END Image Slider -->
