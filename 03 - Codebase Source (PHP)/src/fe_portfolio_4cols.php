    ...
    <div class="content content-full">
        ...
        <div class="js-filter">
            ...
            <div class="row items-push py-30">
                ...
                <div class="col-sm-6 col-md-3" data-category="webapp">
                    <a class="img-link" href="fe_portfolio_single.php">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo1.png" alt="Project 10 Promo">
                    </a>
                </div>
                <div class="col-sm-6 col-md-3" data-category="photography">
                    <a class="img-link" href="fe_portfolio_single.php">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo5.png" alt="Project 11 Promo">
                    </a>
                </div>
                <div class="col-sm-6 col-md-3" data-category="webapp">
                    <a class="img-link" href="fe_portfolio_single.php">
                        <img class="img-fluid" src="<?php echo $cb->assets_folder; ?>/img/various/fe-project-promo3.png" alt="Project 12 Promo">
                    </a>
                </div>
            </div>
        </div>
