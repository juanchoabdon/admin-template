    ...
    <div class="hero bg-black-op">
        <div class="hero-inner">
            <div class="content content-full text-center">
                ...
                <a class="btn btn-hero btn-lg btn-noborder btn-rounded btn-success mb-10 invisible" data-toggle="appear" href="https://goo.gl/po9Usv">
                    <i class="fa fa-shopping-bag mr-10"></i> Purchase
                </a>
                <div class="invisible" data-toggle="appear" data-timeout="500">
                    <a class="btn btn-hero btn-sm btn-noborder btn-rounded btn-secondary mr-5 mb-10" href="be_pages_dashboard.php">
                        <i class="si si-rocket mr-5"></i> Preview Backend
                    </a>
                    <a class="btn btn-hero btn-sm btn-noborder btn-rounded btn-secondary mb-10" href="fe_home.php">
                        <i class="si si-moustache mr-5"></i> Preview Frontend
                    </a>
                </div>
            </div>
        </div>
...
<div class="bg-white">
    <div class="content">
        <div class="pt-100 pb-50">
            ...
            <div class="row nice-copy my-10">
                <div class="col-md-4 py-20">
                    ...
                    <p class="mb-0">Codebase’s layout is really unique, adaptive and flexible. It enables you to create backend and frontend pages that look great and work seamlessly across mobile and desktop devices.</p>
                </div>
                <div class="col-md-4 py-20">
                    <h4 class="font-size-xl font-w700 text-uppercase mb-10">
        ...
        <div class="row no-gutters pull-b text-center overflow-hidden">
            ...
            <div class="col-4 invisible" data-toggle="appear" data-class="animated fadeInUp" data-offset="-200">
                <a class="options-container" href="fe_home.php">
                    <img class="img-fluid options-item" src="<?php echo $cb->assets_folder; ?>/img/various/landing-promo-layout-frontend.png" srcset="<?php echo $cb->assets_folder; ?>/img/various/landing-promo-layout-frontend@2x.png 2x" alt="Frontend Promo">
                    <div class="options-overlay bg-white">
                        <div class="options-overlay-content">
                            <h3 class="h5 font-w700 text-uppercase mb-5">
                                Explore <span class="text-primary">Frontend</span>
                            </h3>
                        </div>
                    </div>
                </a>
        ...
        <div class="pt-100 pb-50">
            ...
            <div class="row nice-copy py-10">
                ...
                <div class="col-md-4 py-20">
                    ...
                    <p class="mb-0">Carefully designed frontend and backend pages to get inspired and create your own.</p>
                </div>
                <div class="col-md-4 py-20">
