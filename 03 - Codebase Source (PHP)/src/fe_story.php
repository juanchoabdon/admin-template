        ...
        <div class="row justify-content-center py-30">
            <div class="col-md-8">
                ...
                <div class="media mb-30">
                    ...
                    <div class="media-body">
                        <form action="fe_story.php" method="post" onsubmit="return false;">
        ...
        <div class="content content-full">
            <div class="row py-30">
                <div class="col-sm-6 nice-copy">
                    <h3 class="font-w700 text-white mb-10 text-center text-sm-left">Looking for more stories?</h3>
                    <p class="text-body-bg-dark mb-0">We write and publish new top-notch stories each week. If you would like to gain access to all our premium content, including our handcrafted toolbox, join us today and take advantage of our <span class="badge badge-danger">30% OFF sale</span>!</p>
                </div>
                <div class="col-sm-6 d-flex justify-content-center align-items-center mt-10">
                    <a class="btn btn-hero btn-lg btn-rounded btn-noborder btn-danger" href="fe_pricing.php">Join Us Today</a>
                </div>
            </div>
        </div>
    </div>
